...
<table class="qftable">
    ...
    foreach ($this->items as $item) {
        ...
        <tr>
            ...
            <td class="qftitle">
                <a href="/wp-admin/admin.php?page=qf3-projects&task=project.edit&id=<?php echo $item->id ?>"><?php echo $item->title ?></a> -> ( <a href="/wp-admin/admin.php?page=qf3-forms&projectid=<?php echo $item->id ?>"><?php echo Text::_('QF_FIELDS'); ?></a> )
            </td>
            <td>
